...
bool UPCharacterMovementComponent::DoJump(bool bReplayingMoves)
{
...
FVector UPCharacterMovementComponent::GetImpartedMovementBaseVelocity() const
{
...
void UPCharacterMovementComponent::JumpOff(AActor* MovementBaseActor)
{
...
FVector UPCharacterMovementComponent::GetBestDirectionOffActor(AActor* BaseActor) const
{
...
void UPCharacterMovementComponent::SetDefaultMovementMode()
{
...
void UPCharacterMovementComponent::OnMovementModeChanged(EMovementMode PreviousMovementMode, uint8 PreviousCustomMode)
{
	if (!HasValidData())
	{
		return;
...
void UPCharacterMovementComponent::PerformAirControlForPathFollowing(FVector Direction, float ZDiff)
{
...
void UPCharacterMovementComponent::PerformAirControlForPathFollowingEx(const FVector& MoveVelocity, const FVector& GravDir)
{
...
FVector UPCharacterMovementComponent::ConstrainAnimRootMotionVelocity(const FVector& RootMotionVelocity, const FVector& CurrentVelocity) const
{
...
void UPCharacterMovementComponent::SimulateMovement(float DeltaSeconds)
{
...
void UPCharacterMovementComponent::MaybeUpdateBasedMovement(float DeltaSeconds)
{
...
void UPCharacterMovementComponent::UpdateBasedMovement(float DeltaSeconds)
{
	if (!HasValidData())
	{
		return;
...
void UPCharacterMovementComponent::UpdateBasedRotation(FRotator& FinalRotation, const FRotator& ReducedRotation)
{
...
void UPCharacterMovementComponent::Crouch(bool bClientSimulation)
{
	if (!HasValidData())
	{
		return;
...
void UPCharacterMovementComponent::UnCrouch(bool bClientSimulation)
{
	if (!HasValidData())
	{
		return;
...
float UPCharacterMovementComponent::SlideAlongSurface(const FVector& Delta, float Time, const FVector& InNormal, FHitResult& Hit, bool bHandleImpact)
{
	if (!Hit.bBlockingHit)
	{
		return 0.0f;
...
void UPCharacterMovementComponent::TwoWallAdjust(FVector& Delta, const FHitResult& Hit, const FVector& OldHitNormal) const
{
...
FVector UPCharacterMovementComponent::HandleSlopeBoosting(const FVector& SlideResult, const FVector& Delta, const float Time, const FVector& Normal, const FHitResult& Hit) const
{
	const FVector CapsuleUp = GetComponentAxisZ();
...
float UPCharacterMovementComponent::ImmersionDepth() const
{
	float Depth = 0.0f;
...
void UPCharacterMovementComponent::RequestDirectMove(const FVector& MoveVelocity, bool bForceMaxSpeed)
{
...
float UPCharacterMovementComponent::GetMaxJumpHeight() const
{
...
void UPCharacterMovementComponent::PhysFlying(float deltaTime, int32 Iterations)
{
...
void UPCharacterMovementComponent::ApplyRootMotionToVelocityOVERRIDEN(float deltaTime)
{
...
void UPCharacterMovementComponent::PhysSwimming(float deltaTime, int32 Iterations)
{
	if (deltaTime < MIN_TICK_TIME)
	{
		return;
...
void UPCharacterMovementComponent::StartSwimmingOVERRIDEN(FVector OldLocation, FVector OldVelocity, float timeTick, float remainingTime, int32 Iterations)
{
...
FVector UPCharacterMovementComponent::GetFallingLateralAcceleration(float DeltaTime)
{
	return GetFallingLateralAccelerationEx(DeltaTime, GetGravityDirection(true));
}

FVector UPCharacterMovementComponent::GetFallingLateralAccelerationEx(float DeltaTime, const FVector& GravDir) const
{
...
FVector UPCharacterMovementComponent::GetAirControl(float DeltaTime, float TickAirControl, const FVector& FallAcceleration)
{
	return GetAirControlEx(DeltaTime, TickAirControl, FallAcceleration, GetGravityDirection(true));
}

FVector UPCharacterMovementComponent::GetAirControlEx(float DeltaTime, float TickAirControl, const FVector& FallAcceleration, const FVector& GravDir) const
{
	// Boost.
...
float UPCharacterMovementComponent::BoostAirControl(float DeltaTime, float TickAirControl, const FVector& FallAcceleration)
{
	return BoostAirControlEx(DeltaTime, TickAirControl, FallAcceleration, GetGravityDirection(true));
}

float UPCharacterMovementComponent::BoostAirControlEx(float DeltaTime, float TickAirControl, const FVector& FallAcceleration, const FVector& GravDir) const
{
...
void UPCharacterMovementComponent::PhysFalling(float deltaTime, int32 Iterations)
{
...
FVector UPCharacterMovementComponent::LimitAirControl(float DeltaTime, const FVector& FallAcceleration, const FHitResult& HitResult, bool bCheckForValidLandingSpot)
{
	return LimitAirControlEx(DeltaTime, FallAcceleration, HitResult, GetGravityDirection(true), bCheckForValidLandingSpot);
}

FVector UPCharacterMovementComponent::LimitAirControlEx(float DeltaTime, const FVector& FallAcceleration, const FHitResult& HitResult, const FVector& GravDir, bool bCheckForValidLandingSpot) const
{
...
bool UPCharacterMovementComponent::CheckLedgeDirection(const FVector& OldLocation, const FVector& SideStep, const FVector& GravDir) const
{
...
FVector UPCharacterMovementComponent::GetLedgeMove(const FVector& OldLocation, const FVector& Delta, const FVector& GravDir) const
{
...
void UPCharacterMovementComponent::StartFalling(int32 Iterations, float remainingTime, float timeTick, const FVector& Delta, const FVector& subLoc)
{
...
FVector UPCharacterMovementComponent::ComputeGroundMovementDelta(const FVector& Delta, const FHitResult& RampHit, const bool bHitFromLineTrace) const
{
	const FVector CapsuleUp = GetComponentAxisZ();
	return ComputeGroundMovementDeltaEx(FVector::VectorPlaneProject(Delta, CapsuleUp), CapsuleUp, RampHit, bHitFromLineTrace);
}

FVector UPCharacterMovementComponent::ComputeGroundMovementDeltaEx(const FVector& Delta, const FVector& DeltaPlaneNormal, const FHitResult& RampHit, const bool bHitFromLineTrace) const
{
...
void UPCharacterMovementComponent::MoveAlongFloor(const FVector& InVelocity, float DeltaSeconds, FStepDownResult* OutStepDownResult)
{
	if (!CurrentFloor.IsWalkableFloor())
	{
		return;
...
void UPCharacterMovementComponent::MaintainHorizontalGroundVelocity()
{
	if (bMaintainHorizontalGroundVelocity)
	{
...
void UPCharacterMovementComponent::PhysWalking(float deltaTime, int32 Iterations)
{
...
void UPCharacterMovementComponent::AdjustFloorHeight()
{
...
void UPCharacterMovementComponent::SetPostLandedPhysics(const FHitResult& Hit)
{
	if (CharacterOwner)
	{
		if (CanEverSwim() && IsInWater())
...
void UPCharacterMovementComponent::OnTeleported()
{
	if (!HasValidData())
	{
		return;
...
void UPCharacterMovementComponent::PhysicsRotation(float DeltaTime)
{
...
void UPCharacterMovementComponent::PhysicsVolumeChanged(class APhysicsVolume* NewVolume)
{
	if (!HasValidData())
	{
		return;
...
bool UPCharacterMovementComponent::ShouldJumpOutOfWater(FVector& JumpDir)
{
	return ShouldJumpOutOfWaterEx(JumpDir, GetGravityDirection(true));
}

bool UPCharacterMovementComponent::ShouldJumpOutOfWaterEx(FVector& JumpDir, const FVector& GravDir)
{
...
bool UPCharacterMovementComponent::CheckWaterJump(FVector CheckPoint, FVector& WallNormal)
{
	return CheckWaterJumpEx(CheckPoint, GetGravityDirection(true), WallNormal);
}

bool UPCharacterMovementComponent::CheckWaterJumpEx(FVector CheckPoint, const FVector& GravDir, FVector& WallNormal)
{
	if (!HasValidData())
	{
		return false;
...
void UPCharacterMovementComponent::MoveSmooth(const FVector& InVelocity, const float DeltaSeconds, FStepDownResult* OutStepDownResult)
{
	if (!HasValidData())
	{
		return;
...
bool UPCharacterMovementComponent::IsWalkable(const FHitResult& Hit) const
{
	if (!Hit.IsValidBlockingHit())
	{
...
bool UPCharacterMovementComponent::IsWithinEdgeTolerance(const FVector& CapsuleLocation, const FVector& TestImpactPoint, const float CapsuleRadius) const
{
	return IsWithinEdgeToleranceEx(CapsuleLocation, GetComponentAxisZ() * -1.0f, CapsuleRadius, TestImpactPoint);
}

bool UPCharacterMovementComponent::IsWithinEdgeToleranceEx(const FVector& CapsuleLocation, const FVector& CapsuleDown, const float CapsuleRadius, const FVector& TestImpactPoint) const
{
...
void UPCharacterMovementComponent::ComputeFloorDist(const FVector& CapsuleLocation, float LineDistance, float SweepDistance, FFindFloorResult& OutFloorResult, float SweepRadius, const FHitResult* DownwardSweepResult) const
{
...
bool UPCharacterMovementComponent::FloorSweepTest(FHitResult& OutHit, const FVector& Start, const FVector& End, ECollisionChannel TraceChannel,
...
bool UPCharacterMovementComponent::IsValidLandingSpot(const FVector& CapsuleLocation, const FHitResult& Hit) const
{
	if (!Hit.bBlockingHit)
	{
		return false;
...
bool UPCharacterMovementComponent::ShouldCheckForValidLandingSpot(float DeltaTime, const FVector& Delta, const FHitResult& Hit) const
{
	const FVector CapsuleUp = GetComponentAxisZ();
...
bool UPCharacterMovementComponent::ShouldComputePerchResult(const FHitResult& InHit, bool bCheckRadius) const
{
...
bool UPCharacterMovementComponent::ComputePerchResult(const float TestRadius, const FHitResult& InHit, const float InMaxFloorDist, FFindFloorResult& OutPerchFloorResult) const
{
...
bool UPCharacterMovementComponent::StepUp(const FVector& GravDir, const FVector& Delta, const FHitResult& InHit, struct UCharacterMovementComponent::FStepDownResult* OutStepDownResult)
{
...
void UPCharacterMovementComponent::HandleImpact(const FHitResult& Impact, float TimeSlice, const FVector& MoveDelta)
{
	if (CharacterOwner)
	{
...
void UPCharacterMovementComponent::ApplyImpactPhysicsForces(const FHitResult& Impact, const FVector& ImpactAcceleration, const FVector& ImpactVelocity)
{
...
void UPCharacterMovementComponent::DisplayDebug(UCanvas* Canvas, const FDebugDisplayInfo& DebugDisplay, float& YL, float& YPos)
{
...
void UPCharacterMovementComponent::VisualizeMovement() const
{
...
FVector UPCharacterMovementComponent::ConstrainInputAcceleration(const FVector& InputAcceleration) const
{
...
void UPCharacterMovementComponent::ServerMoveHandleClientError(float ClientTimeStamp, float DeltaTime, const FVector& Accel, const FVector& RelativeClientLoc, UPrimitiveComponent* ClientMovementBase, FName ClientBaseBoneName, uint8 ClientMovementMode)
{
...
void UPCharacterMovementComponent::ClientAdjustPosition_Implementation(float TimeStamp, FVector NewLocation, FVector NewVelocity, UPrimitiveComponent* NewBase, FName NewBaseBoneName, bool bHasBase, bool bBaseRelativePosition, uint8 ServerMovementMode)
{
...
void UPCharacterMovementComponent::CapsuleTouched(UPrimitiveComponent* OverlappedComp, AActor* Other, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	if (!bEnablePhysicsInteraction)
	{
		return;
...
void UPCharacterMovementComponent::ApplyDownwardForce(float DeltaSeconds)
{
...
void UPCharacterMovementComponent::ApplyRepulsionForce(float DeltaSeconds)
{
...
void UPCharacterMovementComponent::ApplyAccumulatedForces(float DeltaSeconds)
{
...
FVector UPCharacterMovementComponent::GetGravity() const
{
...
FVector UPCharacterMovementComponent::GetGravityDirection(bool bAvoidZeroGravity) const
{
...
float UPCharacterMovementComponent::GetGravityMagnitude() const
{
	return FMath::Abs(GetGravityZ());
}

void UPCharacterMovementComponent::SetGravityDirection(const FVector& NewGravityDirection)
{
	SetCustomGravityDirection(NewGravityDirection.GetSafeNormal());
}

FORCEINLINE void UPCharacterMovementComponent::SetCustomGravityDirection(const FVector& NewCustomGravityDirection)
{
...
void UPCharacterMovementComponent::ClientSetCustomGravityDirection_Implementation(const FVector& NewCustomGravityDirection)
{
	SetCustomGravityDirection(NewCustomGravityDirection);
}

void UPCharacterMovementComponent::ClientClearCustomGravityDirection_Implementation()
{
	SetCustomGravityDirection(FVector::ZeroVector);
}

void UPCharacterMovementComponent::ClientSetGravityPoint_Implementation(const FVector& NewGravityPoint)
{
	GravityPoint = NewGravityPoint;
}

void UPCharacterMovementComponent::ClientClearGravityPoint_Implementation()
{
	GravityPoint = FVector::ZeroVector;
}

void UPCharacterMovementComponent::ClientSetGravityScale_Implementation(float NewGravityScale)
{
	GravityScale = NewGravityScale;
}

void UPCharacterMovementComponent::UpdateGravity(float DeltaTime)
{
...
FRotator UPCharacterMovementComponent::ConstrainComponentRotation(const FRotator& Rotation) const
{
...
FORCEINLINE FVector UPCharacterMovementComponent::GetComponentAxisX() const
{
...
FORCEINLINE FVector UPCharacterMovementComponent::GetComponentAxisZ() const
{
...
FVector UPCharacterMovementComponent::GetComponentDesiredAxisZ() const
{
...
void UPCharacterMovementComponent::UpdateComponentRotation()
{
	if (!HasValidData())
	{
		return;
